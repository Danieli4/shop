                    ...
                    <div class="d-lg-block d-none">
                        <div class="row g-0 position-relative">
                            <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
                                <div class="logo"><a href="index.html"> <img src="/assets/images/logo/logo.png"
                                                                             alt=""> </a>
                                </div>
                            </div>
...
export default {
    ...
    created() {
        this.$router.onError(error => {
            ...
            // Выводим ошибку пользователю или делаем другие действия
            // например, с помощью уведомления или модального окна
