                    ...
                    <div class="row g-0 ">
                        <div class="col-12">
                            <div class="top-info__top-content d-flex align-items-center justify-content-between">
                                ...
                                </div><a href="#0" class="international-shopping d-lg-block d-none "> FREE SHIPPING OVER
                            ...
                            <ul class="page-dropdown-menu d-flex align-items-center justify-content-center">
                                ...
                                <li class="dropdown-list"> <a href="#0"> <span>Shop </span> <span class="menuarrow"> <i
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="shop-grid-right-sidebar.html">Shop Grid Right Sidebar </a></li>
                                        <li><a href="shop-list-right-sidebar.html">Shop List Right Sidebar</a></li>
                                        <li class="submenu-parent"> <a href="#0"> <span>Shop Details Style </span> <span
                                            class="menuarrow"> <i class="flaticon-next-1"></i> </span> </a>
                                            <ul class="submenu">
        ...
        <div class="side-cart d-flex flex-column justify-content-between">
            ...
            <div class="bottom">
                ...
                <div class="button-box d-flex justify-content-between">
                    <router-link to='/cart' class="btn_black"><span> View Cart</span> </router-link>
                            ...
                            <div class="table-outer">
                                <table class="cart-table">
                                    ...
                                    <tr v-for="product in products">
                                        ...
                                        <td>
                                            <div @click.prevent="removeProduct(product.id); getSubtotal()" class="remove"> <i class="flaticon-cross"></i> </div>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 mt-30 wow fadeInUp animated">
                        <div class="footer-default__single-box">
                            ...
                            <ul class="footer-links">
                                ...
                                <li> <router-link to='/cart' class="btn_black"><span> View Cart</span> </router-link></li>
