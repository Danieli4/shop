                                ...
                                <div class="sidebar-holder">
                                        ...
                                        <ul class="color-option">
                                            <li v-for="color in filterList.colors">
                                                <a @click.prevent="addColor(color.id)" href="#0"
                                                   class="color-option-single" :style="`background:#${color.title}` ">
                                    ...
                                    <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                                        ...
                                        <div class="slider-box">
                                            ...
                                            <button @click.prevent="getProductList()" class="filterbtn" type="submit">
                                                Filter
                                            </button>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="products-three-single w-100  mt-30">
                                                        <div class="products-three-single-img">
                                                            <a href="shop-details-3.html" class="d-block">
                                                                <img :src="product.image_url" class="first-img" alt=""> <img src="assets/images/home-three/productss2-hover-1.png" alt="" class="hover-img">
                                                            </a>
                                                            <div class="products-grid-one__badge-box"> <span
                                                                class="bg_base badge new ">New</span>
                                                            </div>
                                                            <a @click.prevent="addToCart(product, true) "
                                                               href="cart.html"
                                                                            ...
                                                                            <div class="color-varient">
                                                                                ...
                                                                                <template
                                                                                    ...
                                                                                    <a @click.prevent="getProduct(groupProduct.id)"
                                                                                       ...
                                                                                       class="color-name pink"> <span>Pink</span>
                                                                                    </a>
                                                                                </template>
                                                                            </div>
...
">
                                        ...
                                        <li v-if="pagination.current_page !== pagination.last_page " class="next">
                                            <a @click.prevent="getProducts(pagination.from+1)" href="#0">
...
export default {
    ...
    methods: {
        ...
        getProducts(page = 1) {
            this.axios.post('http://127.0.0.1/api/products', {
        ...
        getProduct(id) {
            this.axios.get(`http://127.0.0.1/api/products/${id}`)
                .then(res => {
        ...
        getFilterList() {
            this.axios.get(`http://127.0.0.1/api/products/filters`)
                .then(res => {
